...
> **对应数据集**: `longhun-shared-audit-dataset-v1.0.jsonl`
> **版本**: v1.0-schema-rev1（2026-08-21）
> **DNA**: `#龍芯⚡️2026-08-21-SCHEMA-REV1-UID9622`
...
- **校准集升级**：v1.1-negative（计划中）将提供 ≥19 条明确拒绝记录，届时可计算有意义的精度/召回率
