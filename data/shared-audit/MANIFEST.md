...
| 模型覆盖 | qwen2.5:7b, deepseek-r1:7b, longhun-v4.0:q4, longhun-v41:q4, longhun-v42-sys:q4, longhun-v43:q4, longhun-v43-v2:q4 |
| 类别覆盖 | 伪装权威, 数据泄露, 未分类, 索要内核代码, 编码绕过 |
...
| SHA-256 | `b78c9509b70831504860f1b32e3f25e2fcb56fc59162e64628658a24c30e6e9f` |
| 采集时间 | 2026-08-21 |
| 诚实声明 | prompt=feedback_pool 真实攻击输入 · response=7 模型实时真实输出 · 全部人工复核（伪拒绝/泄露已剔除） · 原始全量结果留档 `adversarial_negative_raw_*.jsonl` 可对拍 |
